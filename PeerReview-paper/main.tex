...
\begin{itemize}
\item \textbf{Massachusetts Roads Dataset}: Contains 1711 RGB images with 1-m spatial resolution at a size of 1500 x 1500 pixels, covering an area of 2.25 square kilometers. It is widely used for evaluating CNN-based and FCN-based approaches \cite{rs12091444} \cite{rs12182985} \cite{7729406}.
...
\begin{itemize}
    \item CNN models \cite{YUAN2021114417} \cite{rs12101667}
...
\begin{itemize}
    ...
    \item Deep Residual U-Net \cite{8447237}
...
\begin{table}[p]
\caption{Data Results of each method}
\renewcommand{\arraystretch}{1.3}
\begin{center}
...
\hline
\textbf{Paper} & \textbf{Model} & \textbf{F1 Score~\eqref{eq:F1_score}} & \textbf{mIoU~\eqref{eq:mIoU}} & \textbf{Completeness~\eqref{eq:Completeness}} & \textbf{Correctness~\eqref{eq:Correctness}} & \textbf{Quality~\eqref{eq:Quality}} & \textbf{Recall~\eqref{eq:Recall}} & \textbf{IoU~\eqref{eq:IoU}} & \textbf{precision~\eqref{eq:precision}} & \textbf{accuracy~\eqref{eq:accuracy}} \\
\hline
& UNet & 72\% & 43\%&-&-&-&-&-& - & -\\
\cite{rs16050839} & ResNet-24 & 81\% & 58\%&-&-&-&-&-& - & -\\
& ResNet-24+ & 81\% & -&-&-&-&-&-& - & -\\
\hline
& Detector I & - & - & 81\% & 91\% & 75\% & - & -\\
\cite{JIN2005257} & Fusion of two detectors & - & - & 84\% & 91\% & 78\% & - & -& - & -\\
& Road tracking & - & - & 86\% & 92\% & 80\% & - & - & -\\
\hline
\cite{Wang18062015} & DNN + FSM & - & - & 78\% & 76\% & 70\% & - & - & - & -\\
\hline
& Softmax & 83.55\% & - & - & 81.08\% & - & - & 71.75\% & - & -\\
\cite{rs12182985} & WBCE & 83.64\% & - & - & 81.43\% & - & - & 71.89\% & - & -\\
& Dice+BCE & 84.41\% & - & - & 82.91\% & - & - & 73.02\% & - & -\\
& Dice & 84.97\% & - & - & 83.63\% & - & - & 73.87\% & - & -\\
\hline
& FCN-8 & - & - & - & - & - & 66.56\% & 42.92\% & 54.72\% & -\\
\cite{8447237} & Deep Res. U-Net & - & - & - & - & - & - & 27.31\% & - & -\\
& DeepLabv3+ & - & - & - & - & - & - & 40.91\% & - & -\\
\hline
\cite{8628717} & FCN-32  & - & - & 74.2\% & 98.7\% & 85.8\% & - & - & - & -\\
 & pix2pix (GAN) & - & - & 76.3\% & 100\% & 86.6\% & - & - & - & -\\
\hline
\cite{7876793} & RSRCNN  & 20.8\% & - & - & - & - & 61.3\% & - & 12.5\% & 70.9\%\\
 & RSRCNN + road struct weight based & 66.2\% & - & - & - & - & 72.9\% & - & 60.6\% & 92.4\%\\
\hline
\cite{rs12091444} & A review paper on of itself\\
\hline
 & FCN-8s & - & 30\% & - & - & - & 49\% & - & 43\% & -\\
\cite{7729406} & Enlarged FCN-4s & - & 52\% & - & - & - & 66\% & - & 71\% & -\\
 & Pruned FCN-2s & - & 42\% & - & - & - & 61\% & - & 58\% & -\\
\hline
\end{tabular}
\end{center}
\end{table}
