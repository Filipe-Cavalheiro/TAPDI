...
\begin{center}
    ...
    \HRule\\[0.4cm]
    {\large \bf {Motion-Based Interactive Game Using Computer Vision and GPU Acceleration}}\\[0.2cm]
    \HRule\\[1.5cm]
\end{center}
...
\begin{itemize}
    ...
    \item These proportions ensure the entire upper body and extended arms are captured
\end{itemize}
