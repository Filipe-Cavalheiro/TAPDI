...
adjusted through the settings.json file will be mentioned, during the rest of this section whenever "[json]" appears it indicates that the variable in question can be altered.
